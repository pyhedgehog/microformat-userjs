if(!(new Date()).toLocaleFormat) {
  Date.prototype.toLocaleFormat = function(format) {
    ...
    var f = {
      ...
      B:function(dt) {
        return ['January','Februry','March','April','May','June','July','August','September','October','November','December'][dt.getMonth()];
      },
    ...
    if(i>=0) {
      return this.toString(); // fallback to toString if unknown format found
    }
